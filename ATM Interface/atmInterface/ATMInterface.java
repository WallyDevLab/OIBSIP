...
//	        if (userTransactionHistory.containsKey(userID) && userTransactionHistory.get(userID) != null) {
//	            System.out.println("\nTransaction History for " + userID);
//	            System.out.println(userTransactionHistory.get(userID).toString());
//	        } else {
//	            System.out.println("No transaction history found for " + userID);
//	        }
